...
const Work = () => {
 ...
 <div className=" container mx-auto " >
  ...
  <div className=" flex flex-col xl:flex-row gap-x-8">
    ...
    initial='hidden' 
    animate='show' 
    exit='hidden'  className=" h2 xl:mt-12">Projects<span className=" text-accent">.</span></motion.h2>
    <motion.p variants={fadeIn('up' , '0.4')} 
    initial='hidden' 
    animate='show' 
    exit='hidden'  className=" mb-4 max-w-[400px] mx-auto lg:mx-0">
      Here you can find all of the projects and communities I've worked with.
